...
simDataRef = "SIMDATA/simData_orig_0.h5"
simDataNoSTP = "SIMDATA/simData_noSTP.h5"
...
def main():
    ...
    parser.add_argument( "-f", "--fname", type = str, help = "Optional: Name of hdf5 pandas file with data.", default = simDataRef )
    parser.add_argument( "-f2", "--fname2", type = str, help = "Optional: Name of another hdf5 pandas file with data.", default = simDataNoSTP )
    ...
    exptpsd5, exptpsd15 = plotFrame( gs, fig, args, df, 0, 0 )
    if args.fname2:
        df2 = pandas.read_hdf( args.fname2 )
        # Here we check if it is real or synth data
        simpsd5, simpsd15 = plotFrame( gs, fig, args, df2, 1, 0 )
